...
const nationalityOptions = [
  ...
  const COCUpdateEmployee = () => {
    ...
    useEffect(() => {
        const fetchMyData = async () => {
           try {
              const response = await axiosInstance.get(`${import.meta.env.VITE_API_URL}/api/getCOCDetailsEmp/${user.employee_code}`);
   ...
   const FormSections = [
    {
        ...
        fields : [
            {label : 'Employee full name',type : 'select',value : "employee.full_name",options: [formData.employee.full_name],readOnly : true},
            ...
            {label : 'Job Title',type : 'text',value : "employee.title",readOnly : true},
  ...
  const handleSubmit = async(e) => {
     ...
     try{
      ...
      await axiosInstance.post(`${import.meta.env.VITE_API_URL}/api/submit-other-coc-details/${user.company_id}.${employee_code}`, formData.other_details,); 
     }
     catch(err){
     }
  }
...
export default COCUpdateEmployee;